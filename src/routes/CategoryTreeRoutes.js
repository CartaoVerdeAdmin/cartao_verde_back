...
categoryTreeRoutes
  ...
  .post(verifyJwt, verifyIsAdm, CategoryTreeValidator.create, CategoryController.create);

categoryTreeRoutes
  .route("/:id")
  .delete(verifyJwt, verifyIsAdm, CategoryTreeValidator.destroy, CategoryController.destroy)
  .put(verifyJwt, verifyIsAdm, CategoryTreeValidator.update, CategoryController.update);
